...
// CriarPublicacao adiciona uma publicacao nova publicação no banco de dados
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível excluir uma publicação que não é sua"))
		return
	}
